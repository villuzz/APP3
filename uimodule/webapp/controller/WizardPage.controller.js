sap.ui.define([
  ...
  return Controller.extend("PM030.APP3.controller.WizardPage", {
    ...
    _onObjectMatched: async function () {
      ...
      oModel1.setSizeLimit(1000);
      this.getView().setModel(oModel1, "sHelp");

      sap.ui.core.BusyIndicator.hide();
    },
    routeMatched: async function () {
      // this.getView().byId("tSedeTecnica").getModel().setSizeLimit(1000);
      // this.getView().byId("selSede").getModel().setSizeLimit(1000);
