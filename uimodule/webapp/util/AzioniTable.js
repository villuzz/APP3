    ...
    var PisteTableHome = {
        oData: {
            ...
            aColumns: [
              ...
              {id: "Piani-tAzioni-aCol7", order: 7, text: oResource.getText("Classe"), visible: true},
              {id: "Piani-tAzioni-aCol8", order: 8, text: oResource.getText("DesComponente"), visible: true},
              {id: "Piani-tAzioni-aCol9", order: 9, text: oResource.getText("Tplnr"), visible: true},
              {id: "Piani-tAzioni-aCol10", order: 10, text: oResource.getText("Equipment"), visible: true},
              {id: "Piani-tAzioni-aCol11", order: 15, text: oResource.getText("DesBreve"), visible: true},
