    ...
    var PisteTableHome = {
        oData: {
            ...
            aColumns: [
              ...
              {id: "Piani-tbPiani-col22", order: 12, text: oResource.getText("SEDE_ECC"), visible: true},
              {id: "Piani-tbPiani-col27", order: 13, text: oResource.getText("DESC_SEDE"), visible: true},
              ...
              {id: "Piani-tbPiani-col120", order: 67, text: oResource.getText("Toth"), visible: false},
              
              {id: "Piani-tbPiani-col64", order: 70, text: oResource.getText("LSTAR_1"), visible: false},
              {id: "Piani-tbPiani-col65", order: 71, text: oResource.getText("STEUS_1"), visible: false},
              {id: "Piani-tbPiani-col66", order: 72, text: oResource.getText("NUM_1"), visible: false},
              {id: "Piani-tbPiani-col67", order: 73, text: oResource.getText("PERSONE_1"), visible: false},
              {id: "Piani-tbPiani-col68", order: 74, text: oResource.getText("HPER_1"), visible: false},
              {id: "Piani-tbPiani-col121", order: 75, text: oResource.getText("Toth1"), visible: false},

              {id: "Piani-tbPiani-col69", order: 80, text: oResource.getText("LSTAR_2"), visible: false},
              {id: "Piani-tbPiani-col70", order: 81, text: oResource.getText("STEUS_2"), visible: false},
              {id: "Piani-tbPiani-col71", order: 82, text: oResource.getText("NUM_2"), visible: false},
              {id: "Piani-tbPiani-col72", order: 83, text: oResource.getText("PERSONE_2"), visible: false},
              {id: "Piani-tbPiani-col73", order: 84, text: oResource.getText("HPER_2"), visible: false},
              {id: "Piani-tbPiani-col122", order: 85, text: oResource.getText("Toth2"), visible: false},

              {id: "Piani-tbPiani-col75", order: 90, text: oResource.getText("LSTAR_3"), visible: false},
              {id: "Piani-tbPiani-col76", order: 91, text: oResource.getText("STEUS_3"), visible: false},
              {id: "Piani-tbPiani-col77", order: 92, text: oResource.getText("NUM_3"), visible: false},
              {id: "Piani-tbPiani-col78", order: 93, text: oResource.getText("PERSONE_3"), visible: false},
              {id: "Piani-tbPiani-col79", order: 94, text: oResource.getText("HPER_3"), visible: false},
              {id: "Piani-tbPiani-col123", order: 95, text: oResource.getText("Toth3"), visible: false},

              {id: "Piani-tbPiani-col80", order: 100, text: oResource.getText("LSTAR_4"), visible: false},
              {id: "Piani-tbPiani-col81", order: 101, text: oResource.getText("STEUS_4"), visible: false},
              {id: "Piani-tbPiani-col82", order: 102, text: oResource.getText("NUM_4"), visible: false},
              {id: "Piani-tbPiani-col83", order: 103, text: oResource.getText("PERSONE_4"), visible: false},
              {id: "Piani-tbPiani-col84", order: 104, text: oResource.getText("HPER_4"), visible: false},
              {id: "Piani-tbPiani-col124", order: 105, text: oResource.getText("Toth4"), visible: false},

              {id: "Piani-tbPiani-col85", order: 110, text: oResource.getText("LSTAR_5"), visible: false},
              {id: "Piani-tbPiani-col86", order: 111, text: oResource.getText("STEUS_5"), visible: false},
              {id: "Piani-tbPiani-col87", order: 112, text: oResource.getText("NUM_5"), visible: false},
              {id: "Piani-tbPiani-col88", order: 113, text: oResource.getText("PERSONE_5"), visible: false},
              {id: "Piani-tbPiani-col89", order: 114, text: oResource.getText("HPER_5"), visible: false},
              {id: "Piani-tbPiani-col125", order: 115, text: oResource.getText("Toth5"), visible: false},

              {id: "Piani-tbPiani-col95", order: 120, text: oResource.getText("RISK"), visible: false},
              {id: "Piani-tbPiani-col96", order: 121, text: oResource.getText("LIMITE"), visible: false},
              {id: "Piani-tbPiani-col103", order: 122, text: oResource.getText("TIPOFREQUENZA"), visible: false},
              {id: "Piani-tbPiani-col97", order: 123, text: oResource.getText("FREQ_TEMPO"), visible: false},
              {id: "Piani-tbPiani-col98", order: 124, text: oResource.getText("UNITA_TEMPO"), visible: false},
              {id: "Piani-tbPiani-col99", order: 125, text: oResource.getText("FREQ_CICLO"), visible: false},
              {id: "Piani-tbPiani-col100", order: 126, text: oResource.getText("UNITA_CICLO"), visible: false},
              {id: "Piani-tbPiani-col101", order: 127, text: oResource.getText("POINT"), visible: false},
              {id: "Piani-tbPiani-col102", order: 128, text: oResource.getText("MPTYP"), visible: false}
            ]
        },
